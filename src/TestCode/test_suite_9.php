...
if (FileSaver::exist($cacheFile)) {
    ...
    $tests = TestGenerator::generatePaths(100, 5, 1);
...
if ($response !== $randomRoute->result) {
    return Result::unsuccessful("Response mismatch. Expected: $randomRoute->result Got: $response");
}
